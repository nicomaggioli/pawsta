...
const PRODUCTS = [{
  ...
  features: [{
    t: "The crunch",
    d: "A crinkle liner sewn inside the plush. It's the sound that got our picky puppy hooked."
  }, {
    t: "Double stitched",
    d: "Reinforced seams that hold up to enthusiastic tug sessions."
  }, {
    t: "Machine washable",
    d: "Toss it in cold, air dry, and the crunch survives."
  }, {
    t: "Just right size",
    d: "Light enough to carry, big enough not to swallow."
  }]
}];
const COLLECTIONS = [{
  id: "all",
